...
logging.basicConfig(filename='rig_single.log', level=logging.DEBUG, format='%(asctime)s %(message)s')
...
def single_project(satdd):
    ...
    Parallel(n_jobs=num_cpu)(delayed(run_rig_on_single_project)(satdd, dataset) for dataset in all_datasets)
